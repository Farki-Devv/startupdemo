...
export const createReview = async (
	...
	try {
		...
		throw new Error('Something went wrong crearte review')
	}
}
export const getReview = async (course: string, clerkId: string) => {
	try {
		...
		throw new Error('Somethin went wrong getReview')
	}
}
...
export const updateReview = async (data: Partial<IReview>) => {
	try {
		...
		throw new Error('Something went wrong updateReview')
	}
}
...
export const getReviews = async (params: GetReviewParams) => {
	try {
		...
		throw new Error('Something went wrong getReviews')
	}
}
...
export const getCourseReviws = async (course: string, limit: number) => {
	try {
		await connectToDatabase()
...
export const getReviewsPercantage = async (id: string) => {
	try {
		await connectToDatabase()
		...
		throw new Error('Errog gettgn percantage !')
	}
}
