		...
		<div className='container mx-auto mt-12 max-w-6xl'>
			<div className='flex items-center justify-between max-md:flex-col max-md:items-start max-md:space-y-2'>
				<h2 className='max-md:self-end'>
					{t('result1')}{' '}
					<span className='gap-1 font-space-grotesk font-bold'>
						{totalCourses}
					</span>{' '}
					{t('result2')}
				</h2>
				...
				<div className='flex items-center gap-2'>
					<p className='hidden md:flex'>{t('sortBy')}</p>
			...
			{courses.length === 0 && (
				<NoResult
					...
					description='O`zingizga mos kurslarni  toping! 🚀 Xozirda sizning so`rovingizga to`g`ri  keladigan kurslar bizdamavjud emas. Tez kunda qo`shiladi 💡'
				/>
			)}
			<div className='mt-10'>
