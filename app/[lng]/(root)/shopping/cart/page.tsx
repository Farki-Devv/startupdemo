						...
						<CardContent className='py-4'>
							{carts.length > 0 && (
								<>
									...
									<p className='gap-x-1 text-sm text-muted-foreground'>
										{t('youHave')}
										{carts.length} {t('itemsInCart')}
									</p>
								</>
							)}
							{carts.length === 0 && (
								...
								{carts.length ? (
									...
									>
										<Link href={'/shopping/checkout'}>
											...
											<div className='flex items-center gap-1 opacity-40 transition-all group-hover:opacity-100'>
